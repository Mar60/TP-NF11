...
public interface PreLogoListener extends ParseTreeListener {
	...
	/**
	 * Enter a parse tree produced by {@link PreLogoParser#facteur}.
	 * @param ctx the parse tree
	 */
	void enterFacteur(PreLogoParser.FacteurContext ctx);
	/**
	 * Exit a parse tree produced by {@link PreLogoParser#facteur}.
	 * @param ctx the parse tree
	 */
	void exitFacteur(PreLogoParser.FacteurContext ctx);
	/**
